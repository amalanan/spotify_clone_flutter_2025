...
import 'package:spotify_clone_november_2025/presentation/song_player/bloc/song_player_cubit.dart';
import 'package:spotify_clone_november_2025/presentation/song_player/bloc/song_player_state.dart';
...
class SongPlayerPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocProvider(
        create: (_) {
          return SongPlayerCubit()..loadSong(
