...
import 'package:spotify_clone_november_2025/presentation/home/bloc/playlist_cubit.dart';
      ...
      child: BlocBuilder<PlaylistCubit, PlaylistState>(
        builder: (context, state) {
          ...
          if (state is PlaylistLoaded) {
            print("Number of songs bbbbbb: ${state.songs.length}");
            for (var song in state.songs) {
              print(
                "Title: ${song.title}, Artist: ${song.artist}, ID: ${song
                    .songId}",
              );
            }
            return Padding(
